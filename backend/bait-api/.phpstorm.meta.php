...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \App\Modules\UserData\Domain\Models\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/ivan/UTN/prog4/Bait---Social-Media-Project/backend/bait-api/public/storage' => 'string',
            'jwt.secret' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/ivan/UTN/prog4/Bait---Social-Media-Project/backend/bait-api/public/storage','jwt.secret','jwt.keys.public',
...
'session.same_site','session.partitioned','sanctum.stateful','sanctum.guard','sanctum.expiration',
